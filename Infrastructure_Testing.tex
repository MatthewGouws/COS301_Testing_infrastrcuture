...
\hline
addAuthorizationRest - Adds an authorization restriction for a user role in a particular buzz space. & Could not NPM install due to missing dependencies, as a result could not run & Only Mock functionality, does not run\\ %
\hline
updateAuthorizationRest - Facilitates editing of authorization restrictions. &  Could not NPM install due to missing dependencies, as a result could not run & Only Mock functionality, does not run\\ %
\hline
removeAuthorizationRest - Removes an authorization restriction for a user role from a buzz space. &  Could not NPM install due to missing dependencies, as a result could not run & Only Mock functionality, does not run\\ %
\hline
getAuthorizationRest - Retrieves the authorization restriction to enable users to select a restriction to update. &  Could not NPM install due to missing dependencies, as a result could not run & Only Mock functionality, does not run\\ %
\hline
isAuthorized - Queries the services a user may access in order to customize the UI for the user. & Could not NPM install due to missing dependencies, as a result could not run& Only Mock functionality, does not run\\ %
\hline
